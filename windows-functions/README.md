...
4. Import the `Window Functions.py` notebook archive using the URL method: `https://github.com/data-derp/small-exercises/blob/master/window-functions/Window%20Functions.py`
