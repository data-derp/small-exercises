...
4. Import the `Gentle Introduction to Spark.py` notebook using the URL method: `https://raw.githubusercontent.com/data-derp/small-exercises/master/gentle-introduction-to-spark/Gentle%20Introduction%20to%20Spark.py`
