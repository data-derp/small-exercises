...
# MAGIC 
# MAGIC Apache Spark is a <b>unified computing engine</b> and set of <b>libraries</b> for <b>parallel data processing</b> on **computer clusters**. This defination has 3 components that have been broken down below:
