...
4. Import the `Basic Scala.scala` notebook using the URL method: `https://raw.githubusercontent.com/data-derp/small-exercises/master/basic-scala/Basic%20Scala.scala`
