...
4. Import the `delta-lake-walkthrough.dbc` notebook using the URL method: `https://github.com/data-derp/small-exercises/blob/master/delta-lake-walkthrough/delta-lake-walkthrough.dbc`
